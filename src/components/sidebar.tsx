...
const navItems = [
  ...
  { href: "/compare", label: "比較", icon: "M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" },
  { href: "/kpi", label: "KGI/KPI管理", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  { href: "/help", label: "ヘルプ", icon: "M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" },
];
